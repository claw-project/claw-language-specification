...
the array index in the block according to the given plus/minus offset. If the array referenced in the data clause is assigned in the block, 
the caching will take its place (see example \ref{kcache1}). Otherwise, an assignment is created (see example \ref{kcache2}). 
